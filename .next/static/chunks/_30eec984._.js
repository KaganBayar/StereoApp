(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_30eec984._.js", {
...
async function handleLogin(previousState, formData) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])(formData);
        const email = formData.get("email");
        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["findUserByEmail"])(email);
        if (!user) {
...
const AuthDialog = ()=>{
    ...
    async function handleRegister(prevState, formData) {
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["register"])(formData); //server action
            const email = formData.get("email");
...
const Header = ()=>{
    ...
    const handleLogout = ()=>{
        if (dispatch && user) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logout"])(user.user.id);
        } else {
...
//# sourceMappingURL=_30eec984._.js.map