...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ login(formData) {
    ...
    cookieStore.set("fake Cookie", "fake value", {
        httpOnly: true
    });
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].post("http://localhost:3000/api/login", {
        userId: `${user.id}`,
        username: `${user.name}`,
        email: `${user.email}`,
        roles: `${user.roles}`,
...
"[project]/.next-internal/server/app/(Home)/search/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/lib/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/(Home)/search/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/lib/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/(Home)/search/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/lib/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <exports>": ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/(Home)/search/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/lib/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__297193b6._.js.map