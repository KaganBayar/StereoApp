...
async function verifyToken(token) {
    if (!token) {
        ...
        try {
            const verifiedToken = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$node$2f$esm$2f$jwt$2f$verify$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jwtVerify"])(token, new TextEncoder().encode(process.env.JWT_SECRET_KEY));
...
async function signToken(obj) {
    ...
    const jwt = await new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$node$2f$esm$2f$jwt$2f$sign$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SignJWT"](obj).setProtectedHeader({
        alg: "HS256"
...
async function POST(request) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].refreshTokens.create({
        data: {
            token: refreshToken,
            user_id: userId,
    ...
    const accessToken = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["signToken"])({
        userId: userId,
        email: email,
        name: username,
        roles: roles,
    ...
    const verifiedAccesToken = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyToken"])(accessToken);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__39016f51._.js.map