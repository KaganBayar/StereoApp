                ...
                .map((artist) => (
                  ...
                  >
                    <div className="relative mb-4">
                      ...
                      <Button className="absolute bottom-2 right-2 bg-green-500 hover:bg-green-400 text-black rounded-full h-10 w-10 p-0 shadow-lg opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-200">
        ...
        {(activeSection === "all" || activeSection === "songs") && (
          <div>
            ...
            <div className="space-y-1">
              {mockData.songs
                .slice(0, activeSection === "all" ? 5 : undefined)
                .map((song, index) => (
                  <div
                    key={song.id}
                    className={`${
