...
import { Search, X, Clock, TrendingUp, Headphones, User, Album, List } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="relative">
        <div className={`relative transition-all duration-200 ${
          ...
          <div className={`flex items-center bg-gray-900/90 rounded-xl border-2 transition-all duration-300 ${
            isFocused
            ...
            {searchQuery ? (
              ...
              <div className="p-4">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-gray-300 font-medium text-sm">Recent searches</span>
                </div>
      ...
      {searchQuery && !isFocused ? (
        ...
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-gray-400 max-w-sm">
            Your search results will appear here once you implement the search functionality.
          </p>
        </div>
      ) : !searchQuery && !isFocused ? (
        /* Browse All Section */
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              { name: "Made For You", bg: "bg-gradient-to-br from-purple-600 to-blue-500" },
              { name: "Charts", bg: "bg-gradient-to-br from-red-500 to-orange-400" },
              { name: "New Releases", bg: "bg-gradient-to-br from-green-500 to-emerald-400" },
              { name: "Discover", bg: "bg-gradient-to-br from-pink-500 to-rose-400" },
              { name: "Concerts", bg: "bg-gradient-to-br from-indigo-500 to-purple-400" },
              { name: "Pop", bg: "bg-gradient-to-br from-yellow-500 to-orange-400" },
              { name: "Hip-Hop", bg: "bg-gradient-to-br from-red-600 to-pink-500" },
              { name: "Rock", bg: "bg-gradient-to-br from-gray-600 to-gray-800" },
              { name: "Mood", bg: "bg-gradient-to-br from-blue-500 to-cyan-400" },
              { name: "Indie", bg: "bg-gradient-to-br from-teal-500 to-green-400" },
              { name: "Workout", bg: "bg-gradient-to-br from-orange-500 to-red-400" },
              { name: "Chill", bg: "bg-gradient-to-br from-blue-400 to-indigo-500" }
            ].map((category, index) => (
              <button
                key={index}
